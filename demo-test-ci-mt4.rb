...
class DemoTestCi	
  ...
  $test_failed_count = 0
  $test_pass_count = 0
  $x = "/inetpub/wwwroot/AutoTestResults/CI-Forms/MT4-Forms/"  # path for logs
...
def setup_browser_firefox 
  $browser = Watir::Browser.new :firefox	# open a browser default is chrome
	  ...
	  tear_down
		  ...
		  $results.puts ""
		  $results.puts "Successfully opened / setup Firefox browser." 
		  $results.puts ""
end
...
def setup_browser_chrome 
  ...
  $browser.send_keys [:control, '-']  # chrome browser - Zoom in or out of a page, "-" will zoom out and "+" will zoom in
	  ...
	  $results.puts ""
	  $results.puts "Unable to opened / setup browser."
	  $results.puts ""
	  tear_down
	  	else
		  $results.puts ""
		  $results.puts "Successfully opened / setup Chrome browser." 
		  $results.puts ""
end
...
def site_connect_ci
  ...
  sleep 2
	  ...
	  $results.puts "Unable to Connect to the Site Host = " + $site_url
		else
		  $results.puts "Successfully Connected to host = " + $site_url
end

def browser_quit  
  $browser.quit
	rescue
	  $results.puts "Unable to quit browser!"
		else
		  $results.puts "Successfully quit browser!"
end

def create_summary_logfile
  get_unique_number
  #$x = "/inetpub/wwwroot/AutoTestResults/CI-Forms/MT4-Forms/"
  y = "MT4FormsSummary" + $unique_number + ".log"
  log_file_create1 = File.new("#{$x}#{y}", "w")
  $summary_results = File.new("#{$x}#{y}", "a")
  # $summary_results = File.new("/inetpub/wwwroot/AutoTestResults/MT4-Forms/demo_form_summary_results.log", "w")
    rescue 
	  puts "Not Able to Create Summary Log File!"
	  exit
	    else
		  $results.puts "Summary Log File Created Successfully!"
end
	
def create_detailed_logfile
  get_unique_number
  # x2 = "/inetpub/wwwroot/AutoTestResults/CI-Forma/MT4-Forms/Details/"
  y2 = "MT4FormsDetailed" + $unique_number + ".log"
  log_file_create2 = File.new("#{$x}#{y2}", "w")
  $results = File.new("#{$x}#{y2}", "a")
  # $results = File.new("/inetpub/wwwroot/AutoTestResults/MT4-Forms/demo_form_detailed_results.log", "w")
  	 rescue 
	   puts "Not Able to Create Detailed Log File!"
	   exit
	      else
		    $results.puts "Detailed Log File Created Successfully!"
end

def summary_logfile_close
  $summary_results.close
    rescue
	  $results.puts "Unable to Close summary log file!"
		else
...
def detailed_logfile_close
  $results.close
	  ...
	  $results.puts "Unable to Close log file!"
		else
		  puts "Successfully closed detailed log file!"
end

def error_title_demo_signup_page
  $results.puts "Test Failed - Unable to validate demo sign-up page's title."
  $summary_results.puts "Test Failed - Unable to validate demo sign-up page's title."
  get_unique_number
  $browser.screenshot.save "#{$x}Demo_Signup_Page_Error" + $unique_number + ".png"
     rescue
	  $results.puts "title Error trapped Failed!"
	    else
	      $results.puts "title Error trapped!"
end

def error_title_confirm_page
  $results.puts "Test Failed - Unable to validate Confirmation Page's Title."
  $summary_results.puts "Test Failed - Unable to validate Confirmation page's title."
  get_unique_number             
  $browser.screenshot.save "#{$x}Confirm_Page_Error" + $unique_number + ".png"
    rescue
	  $results.puts "title Error trapped Failed!"
	    else
	      $results.puts "title Error trapped!"
...
def error_title_submit_page
  $results.puts "Test Failed - Unable to validate Submit Page's Title."
  $summary_results.puts "Test Failed - Unable to validate Submit page's title."
  # get_unique_number             
  # $browser.screenshot.save "#{$x}Submit_Page_Error" + $unique_number + ".png"
    rescue
	  $results.puts "title Error trapped Failed!"
	    else
	      $results.puts "title Error trapped!"
...
def get_server_name
  server_name = $browser.element(:xpath,"//*[contains(@id, 'DebugInfo')]").value
    ...
    $results.puts "unable to find server name!"
       else	
	     $results.puts "Server Name = " + server_name
		 $summary_results.puts "Server = " + server_name
end
...
def setup_negative_test
  ...
  $summary_results.puts "Starting Negative Demo Form Test."
  $results.puts "Starting Negative Demo Form Test."
end
...
def accept_cookie_policy
  ...
  if $browser.element(:xpath,"//*[contains(@class, 'cta-btn blue alert__close')]").exists? == true
         $browser.element(:xpath,"//*[contains(@class, 'cta-btn blue alert__close')]").click
			    ...
			    $results.puts "Cookie opt in button Not Found"
  end
    rescue
	  $results.puts "Error: cookie opt in button method!"
		else
		  $results.puts "Successfully completed cookie opt in method!"
end 
...
def mt_populate_form_first_name		# tests first name test field
  ...
  when "live"
    ...
    $results.puts "Error First Name ID has changed!" 
  end
  sleep 1  
      rescue
	    $results.puts "Unable to find first name element!"
		  else
		    $results.puts "Successfully found first name!"
end
...
def mt_populate_form_last_name		# tests last name text field
  ...
  when "live"
    ...
    $results.puts "Error Last Name ID has changed!" 
	  ...
	  $results.puts "Unable to find last name element!"
	     else
		  $results.puts "Successfully found last name!"
end
...
def mt_populate_form_email			# tests email address text field.
  ...
  when "live"
    ...
    $results.puts "Error email address ID has changed!" 
  end
   	rescue
	  $results.puts "Unable to find email element!"
	  	else
		  $results.puts "Successfully found email element!"
end
...
def mt_populate_form_phone_number
  ...
  when "live"
    ...
    $results.puts "Error Phone number ID has changed!" 
  end
   	rescue
	  $results.puts "Unable to find phone number element!"
	  	else
		  $results.puts "Successfully found phone number element!"
end
...
def mt_set_country_dropdown	
  ...
  when "live"
    ...
    $results.puts "Error Phone number ID has changed!" 
	  ...
	  $results.puts "Unable to set country drop-down box!"
	  # get_unique_number 
	  # $browser.screenshot.save "#{$x}Submit_Page_dropdowm_Error" + $unique_number + ".png"
	  	else
		  $results.puts "Successfully set country drop-down box!"
end
...
def mt_demo_form_submit 
  ...
  $browser.send_keys :enter  
    sleep 4
	    ...
	    $results.puts "Form Submit Failed!"
	    #get_unique_number
...
def mt_validate_confirm_page
  ...
  $results.puts "Expected Confirm title = " + expected_title
	  ...
	  $results.puts "Pass - Demo form sign-up country = " + $country
	  $summary_results.puts "Pass - Demo form sign-up country = " + $country
	  $test_pass_count = $test_pass_count + 1
        else 
		  $results.puts "title values do not match!"
		  $test_failed_count = $test_failed_count + 1
		  error_title_confirm_page
      end
         rescue
           $results.puts "Error validate_confirm_page code."
		     else	
               $results.puts "Successfully validate_confirm_page"
end
...
def mt_validate_title_demo_signup
  ...
  $results.puts "title expected = " + expected_title
  $results.puts "title on page = " + title_from_page
  if title_from_page == expected_title
     #expect($browser.title).to include("Trading Account | Open Demo Trading Account | City Index UK")
	 $results.puts "Validated Demo sign-up form's title"
	 else  
	   $results.puts "title values do not match!"
	   error_title_demo_signup_page
  end   
    rescue
      $results.puts "Error validating Demo form's title."
	    else
          $results.puts "Successfully validated demo form's title."
end
...
part1 = "gaincap"
  ...
  when "live"
    ...
    $results.puts "Error email address is invalid has changed!" 
  end
   	rescue
	  $results.puts "Unable to find email element!"
		else
...
# phone number test field - hard coded must change with country.
  ...
  when "live"
    ...
    $results.puts "Error Phone number is invalid has changed!" 
  end
   	rescue
	  $results.puts "Unable to find phone number element!"
		else
...
def ci_validate_submit_title_page
  ...
  #expected_title = "Advantage Web demo account creation error"
  $results.puts "Expected Submit title = " + expected_title
      if title_from_page == expected_title
        $results.puts "Pass - Submit title page test."
	    $summary_results.puts "Pass - Submit title page test."
          else 
		    $results.puts "title values do not match!"
		    error_title_submit_page
      end
        rescue
          $results.puts "Error validate Submit page title code."
		  
            else	
              $results.puts "Successfully validate Submit page title"
end
...
# This is a negative test for the CI Demo form
  ...
  get_server_name
  ci_validate_title_demo_signup
  $results.puts "Missing First Name Test, Brand = " + $brand
  ci_populate_form_last_name
  ci_populate_form_email
  ci_populate_form_phone_number
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Missing First Name Test Completed Status:" 
  ...
  $summary_results.puts "***** CI Missing First Name Test Completed Status:"
  ...
  $results.puts "**************************************************************************"
  $results.puts "End CI Negative Form Test Missing First Name for Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End CI Missing First Name Test. **************************"
  $summary_results.puts "******************************************************************"
 end 
...
# This is a negative test for the CI Demo form
  ...
  get_server_name
  ci_validate_title_demo_signup
  $results.puts "Missing last name test, brand = " + $brand
  ci_populate_form_first_name
  ci_populate_form_email
  ci_populate_form_phone_number
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Missing Last Name Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Missing Last Name Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  ...
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End CI Missing Last Name Test. **************************"
  $summary_results.puts "******************************************************************"
end 
...
# This is a negative test for the CI Demo form
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Missing Email Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Missing Email Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "**************************************************************************"
  $results.puts "End CI Negative Form Test Missing Email for Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End CI Missing Email Test. *******************************"
  $summary_results.puts "******************************************************************"
end 
...
# This is a negative test for the CI Demo form
  ...
  get_server_name
  ci_validate_title_demo_signup
  $results.puts "Missing phone number test, brand = " + $brand
  ci_populate_form_first_name
  ci_populate_form_last_name
  ci_populate_form_email
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Missing Phone Number Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Missing Phone Number Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "**************************************************************************"
  $results.puts "End CI Negative Form Test Missing Phone Number Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End CI Missing Phone Number Test. ***********************"
  $summary_results.puts "******************************************************************" 
end 
...
def mt_negative_demo_form_submit
  ...
  # $browser.element.button(:xpath,"//*[contains(@class, 'form-submit form-buttonSubmit cta-btn blue')]").click
    sleep 5
	    ...
	    $results.puts "Form Submit Failed! for MT4 Negative Demo Form!"
	    $summary_results.puts "Form Submit Failed! for MT4 Negative Demo Form!"
		# $browser.element.button(:xpath,"//*[contains(@class, 'form-submit form-buttonSubmit cta-btn blue')]").click
	    get_unique_number
	    $browser.screenshot.save "#{$x}MT4_Negative_Submit_Page_Error" + $unique_number + ".png"
	      else
		    $results.puts "Successfully clicked submit button!"
		    $summary_results.puts "Pass - Negative Test MT4"
end
...
# This is a negative test for the MT4 Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Missing First Name Test."
  # setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  $results.puts "***** MT4 Missing First Name Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Missing First Name Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "**************************************************************************"
  $results.puts "End MT4 Negative Form Test Missing First Name for Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End MT4 Missing First Name Test. **************************"
  $summary_results.puts "******************************************************************"
end 
...
# This is a negative test for the MT4 CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Missing Last Name Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 Missing Last Name Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Missing Last Name Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  ...
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End MT4 Missing Last Name Test. **************************"
  $summary_results.puts "******************************************************************"
end 
...
# This is a negative test for the Mt4 CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Missing Email Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 Missing Email Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Missing Email Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "**************************************************************************"
  $results.puts "End MT4 Negative Form Test Missing Email for Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End MT4 Missing Email Test. ******************************"
  $summary_results.puts "******************************************************************"
end 
...
def mt_missing_phone_number
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Missing Phone Number Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 Missing Phone Number Test Completed Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Missing Phone Number Test Completed Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "**************************************************************************"
  $results.puts "End MT4 Negative Form Test Missing Phone Number Country = " + $country 
  $results.puts "**************************************************************************"
  $summary_results.puts "******************************************************************"
  $summary_results.puts "******* End MT4 Missing Phone Number Test. ***********************"
  $summary_results.puts "******************************************************************"
end 
...
# This is a negative test for the MT4 CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Last Name with numbers Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  mt_validate_title_demo_signup
  $results.puts "last name with numbers test, brand = "+$brand
  mt_populate_form_first_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 last Name has Number Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Last Name has Number Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End MT4 Negative Form Test Last Name has Number, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End MT4 Last Name has Number Test. ************************"
  $summary_results.puts "*******************************************************************"
end
...
# This is a negative test for the Mt4 CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting MT4 Email invalid format Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  mt_validate_title_demo_signup
  $results.puts "Email invalid format test, brand = "+$brand
  mt_populate_form_first_name
  mt_populate_form_last_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 Email format invalid Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Email Format invalid Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End MT4 Negative Form Test Email Format invalid, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End MT4 Email Format invalid Test. ************************"
  $summary_results.puts "*******************************************************************"
end
...
# This is a negative test for the Mt4 CI Demo form
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 Phone format invalid Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 Phone Format invalid Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End MT4 Negative Form Test Phone Format invalid, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End MT4 Phone Format invalid Test. ************************"
  $summary_results.puts "*******************************************************************"
end
...
# This is a negative test for the CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting CI Last Name with numbers Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI last Name has Number Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Last Name has Number Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End CI Negative Form Test Last Name has Number, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End CI Last Name has Number Test. *************************"
  $summary_results.puts "*******************************************************************"
end
...
# This is a negative test for the CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting CI Email invalid format Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Email format invalid Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Email Format invalid Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End CI Negative Form Test Email Format invalid, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End CI Email Format invalid Test. ************************"
  $summary_results.puts "*******************************************************************"  
end
...
# This is a negative test for the CI Demo form
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI Phone format invalid Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI Phone Format invalid Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End CI Negative Form Test Phone Format invalid, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End CI Phone Format invalid Test. *************************"
  $summary_results.puts "*******************************************************************"  
end
...
# This is a negative test for the MT4 CI Demo form
  ...
  get_server_name
  mt_validate_title_demo_signup
  $results.puts "last name with 51 char test, brand = "+$brand
  mt_populate_form_first_name
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 51 char Last Name Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 51 char Last Name Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "***************************************************************************"
  $results.puts "End MT4 Negative Form Test 51 char Last Name, Country = " + $country 
  $results.puts "***************************************************************************"
  $summary_results.puts "*******************************************************************"
  $summary_results.puts "******* End MT4 51 char Last Name Test. ***************************"
  $summary_results.puts "*******************************************************************"
end
...
# This is a negative test for the Mt4 CI Demo form
  ...
  mt_negative_demo_form_submit
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 one char First Name Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 one char First Name Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "****************************************************************************"
  $results.puts "End MT4 Negative Form Test one char First Name, Country = " + $country 
  $results.puts "****************************************************************************"
  $summary_results.puts "********************************************************************"
  $summary_results.puts "******* End MT4 one char First Name Test. **************************"
  $summary_results.puts "********************************************************************"  
end
...
# This is a negative test for the MT4 CI Demo form
  ...
  sleep 1
  mt_negative_validate_confirm_page
  $results.puts "***** MT4 one char Last Name Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** MT4 one char Last Name Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "****************************************************************************"
  $results.puts "End MT4 Negative Form Test one char Last Name, Country = " + $country 
  $results.puts "****************************************************************************"
  $summary_results.puts "********************************************************************"
  $summary_results.puts "******* End MT4 one char Last Name Test. ***************************"
  $summary_results.puts "********************************************************************"  
end
...
# This is a negative test for the CI Demo form
  ...
  $test_count1 = $test_count 
  $results.puts ""
  $results.puts "Starting CI one char invalid format Test."
  setup_negative_test
  site_connect_ci
  accept_cookie_policy
  get_server_name
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI one char First Name Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI one char First Name Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "****************************************************************************"
  $results.puts "End CI Negative Form Test one char First Name, Country = " + $country 
  $results.puts "****************************************************************************"
  $summary_results.puts "********************************************************************"
  $summary_results.puts "******* End CI one char First Name Test. ***************************"
  $summary_results.puts "********************************************************************"    
end
...
# This is a negative test for the CI Demo form
  ...
  ci_negative_demo_form_submit
  ci_negative_validate_confirm_page
  $results.puts "***** CI4 one char Last Name Test Completed, Status:" 
  $results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** CI one char Last Name Test Completed, Status:"
  $summary_results.puts "Total Test Executed Pass / Fail (Running Total for Test Audit Trail.)"
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "****************************************************************************"
  $results.puts "End CI Negative Form Test one char Last Name, Country = " + $country 
  $results.puts "****************************************************************************"
  $summary_results.puts "********************************************************************"
  $summary_results.puts "******* End CI one char Last Name Test. ****************************"
  $summary_results.puts "********************************************************************"    
end
...
def after_country_test_print_mt4
  $results.puts "***** Demo Account MT4 Test Status: Country = " + $country
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** Demo Account MT4 Test Status: Country = " + $country
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "******************************************************************** "
  $results.puts "End Demo Form Test for Country = " + $country
  $results.puts "*********************************************************************"
  $summary_results.puts "*************************************************************"
end

def before_country_test_print_ci
  $results.puts "***** Starting Demo Account CI Test: Country = " + $country
  $summary_results.puts "***** Starting Demo Account CI Test: Country = " + $country
end

def after_country_test_print_ci
  $results.puts "***** Demo Account CI Test Status: Country = " + $country
  $results.puts "Test Count = " + $test_count1.to_s
  $results.puts "Test Pass Count = " + $test_pass_count.to_s
  $results.puts "Test Failed Count = " + $test_failed_count.to_s
  $summary_results.puts "***** Demo Account CI Test Status: Country = " + $country
  $summary_results.puts "Test Count = " + $test_count1.to_s
  $summary_results.puts "Test Pass Count = " + $test_pass_count.to_s
  $summary_results.puts "Test Failed Count = " + $test_failed_count.to_s
  $results.puts "******************************************************************** "
...
# ***** Negative tests per brand only the configured brands tests will execute (MT4 or CI) *****
	case $brand  # brand = mt4 or ci
	    ...
	    when "mt4" 
			 ...
			 $results.puts "Error! Negative test Failed to execute!" 
	end
tear_down
# ****************** End of Testing **************************************************
exit
